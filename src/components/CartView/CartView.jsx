    ...
    const handleContinue = () => {
        if (totalProducts === 0) {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'No hay productos seleccionados en el carrito.'
            });
        } else {
            // Continuar al checkout
            console.log("Continuar al checkout");
        }
    };
                    ...
                    <div className="mt-4" key={prod.id}>
                        <div className="row borde py-3">
                                                ...
                                                <div className="cart">
                                                    <div className="row">
                                                        <div className="col-4 d-flex justify-content-end">
                                                            <button onClick={() => removeOneItem(prod.id)} className="agregar">-</button>
                                                        </div>
                            ...
                            <div className="col-2 align-self-center">
                                <button onClick={() => removeItem(prod.id)} className="btn btn-danger quitar">
